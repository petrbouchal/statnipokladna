...
- při ověřování může taky pomoct např.
  ...
  - údaje o výběru daní od Finanční správy:  ([tabulky](https://fs.gov.cz/cs/dane/kraje-a-obce/danove-prijmy-kraju-a-obci), [statistiky](https://fs.gov.cz/cs/dane/analyzy-a-statistiky/udaje-z-vyberu-dani))
