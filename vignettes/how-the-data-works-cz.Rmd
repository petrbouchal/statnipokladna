...
- [základní glosář k terminologii](https://monitor.statnipokladna.gov.cz/metodika/#prijmy)
- [vyhláška o rozpočtové skladbě](https://www.zakonyprolidi.cz/cs/2002-323#p2) - k tomu viz níže
- v popisu struktury v excelech [u jednotlivých datasetů](https://monitor.statnipokladna.gov.cz/datovy-katalog/transakcni-data)
- ledacos se hodí bazálně ověřit proti ručně sestavené tabulce v [analytickém rozhraní](https://monitor.statnipokladna.gov.cz/analyza/)
- při ověřování může taky pomoct např.
  ...
  - údaje o výběru daní od Finanční správy:  ([tabulky](https://financnisprava.gov.cz/cs/dane/kraje-a-obce/danove-prijmy-kraju-a-obci), [statistiky](https://financnisprava.gov.cz/cs/dane/analyzy-a-statistiky/udaje-z-vyberu-dani))

## Soustava prvků dostupných ze státní pokladny

- [číselníky](https://monitor.statnipokladna.gov.cz/datovy-katalog/ciselniky)
- výkazy (publikovány jako ["transakční data"](https://monitor.statnipokladna.gov.cz/datovy-katalog/transakcni-data)) bez téměř jakýkcholi lidsky čitelných identifikátorů - k tomu je potřeba napojit číselníky
...
Číselníky jsou v XML, ale dají se i prohlížet ([příklad](https://monitor.statnipokladna.gov.cz/datovy-katalog/ciselniky/prohlizec/13)) a tamtéž stáhnout v CSV.
