...
- výkazy (publikovány jako ["transakční data"](http://monitor.statnipokladna.cz/2019/zdrojova-data/transakcni-data)) bez téměř jakýkcholi lidsky čitelných identifikátorů - k tomu je potřeba napojit číselníky
...
Číselníky jsou v XML, ale dají se i prohlížet ([příklad](http://monitor.statnipokladna.cz/2019/zdrojova-data/prohlizec-ciselniku/vykaz?date=7.11.2019)) a tamtéž stáhnout v CSV.
...
- sloupce označující fáze rozpočtového cyklu (ZU_ROZ*) se liší mezi obcemi (výkaz FINM) a státem (výkaz FINU)
- v číselnících jsou občas dvě stejné položky platné v jeden moment, tj. i po profiltrování přes datum (příklad položka 1381 v číselníku položek) - možná je to metodicky správně, ale rozhodně neintuitivní
- URL prohlížeče číselníku ne vždy odpovídá jeho názvu/URL jeho XML souboru (příklad [prohlizec-ciselniku/smeruc](https://monitor.statnipokladna.cz/2019/zdrojova-data/prohlizec-ciselniku/smeruc?date=28.11.2019) x [/uctosnova.xml](https://monitor.statnipokladna.cz/data/uctosnova.xml))
