...
V rozpočtových (a možná i jiných) výkazech jsou sloupce začínající `kon_` s hodnotou true nebo false. Pro konsolidaci na úrovni okresu je to `kon_okr` atd. 
...
- ne zcela rozumím položkám ke konsolidaci (fungují v praxi, ale...), navíc jsem je zkoušel jen u příjmů a výdajů rozpočtůx
