...
- [RCzechia](https://cran.r-project.org/package=RCzechie) for another approach to Czech geospatial data and access to the official public geocoder and reverse geocoder
